...
/**
 * Runs the core round-trip TCK against the CBOR format.
 */
@DisplayName("CBOR Core Round-Trip TCK")
class CborCoreRoundTripTCKTest extends AbstractCoreRoundTripTCK {
