...
/**
 * Abstract feature parity test suite for format providers.
 * <p>
 ...
 * JSON format.
 */
abstract class AbstractFormatFeatureParityTest {

    private static final String TEST_ECORE = "/org/eclipse/fennec/codec/format/test-format-parity.ecore";
