...
| `codec.serializeDefault` | `CODEC_SERIALIZE_DEFAULT` | Boolean | `false` | Write features whose value equals the EAttribute default. The former plural constant `CODEC_SERIALIZE_DEFAULTS` was removed. |
