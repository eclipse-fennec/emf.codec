...
/**
 * Demonstrates switching between JSON, YAML, CBOR, and BSON formats
 * using {@link CodecFormatProvider}.
 *
 * @see <a href="docs/codec-v2-spec/17-format-abstraction.md">Spec: Format Abstraction</a>
 */
@DisplayName("Format Provider Examples")
class FormatProviderExample {
