...
/**
 * Full round-trip tests for {@link BsonFormatProvider} through {@link CodecResource}.
 * <p>
 * Verifies that EMF EObjects can be serialized to BSON binary format and
 * deserialized back with all values preserved. This is the BSON equivalent
 * of the JSON feature parity tests.
 */
@DisplayName("BsonFormatProvider")
class BsonFormatProviderTest {

    private static final String TEST_ECORE = "/org/eclipse/fennec/codec/bson/test-format-parity.ecore";
    ...
    void setUp() throws IOException {
        ecoreHelper = new EcoreHelper(BsonFormatProviderTest.class);
    ...
    private CodecResource createResource() {
        return new CodecResource(
                URI.createURI("test://parity.bson"),
                metadataService,
