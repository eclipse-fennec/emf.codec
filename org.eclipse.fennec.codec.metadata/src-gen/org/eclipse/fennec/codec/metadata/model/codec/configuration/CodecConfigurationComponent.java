...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.codec.metadata.model.codec\"" })
...
public class CodecConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(CodecPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(CodecPackage.eNS_URI, ePackage);
		}
