 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.codec.metadata.model.codec.impl.BaseFeatureConfigImpl#getKey <em>Key</em>}</li>
 *   <li>{@link org.eclipse.fennec.codec.metadata.model.codec.impl.BaseFeatureConfigImpl#getIgnore <em>Ignore</em>}</li>
 *   <li>{@link org.eclipse.fennec.codec.metadata.model.codec.impl.BaseFeatureConfigImpl#getIgnoreRead <em>Ignore Read</em>}</li>
 *   <li>{@link org.eclipse.fennec.codec.metadata.model.codec.impl.BaseFeatureConfigImpl#getIgnoreWrite <em>Ignore Write</em>}</li>
 *   <li>{@link org.eclipse.fennec.codec.metadata.model.codec.impl.BaseFeatureConfigImpl#getForceRead <em>Force Read</em>}</li>
 *   <li>{@link org.eclipse.fennec.codec.metadata.model.codec.impl.BaseFeatureConfigImpl#getForceWrite <em>Force Write</em>}</li>
 *   <li>{@link org.eclipse.fennec.codec.metadata.model.codec.impl.BaseFeatureConfigImpl#getSerializeNull <em>Serialize Null</em>}</li>
 *   <li>{@link org.eclipse.fennec.codec.metadata.model.codec.impl.BaseFeatureConfigImpl#getSerializeEmpty <em>Serialize Empty</em>}</li>
 *   <li>{@link org.eclipse.fennec.codec.metadata.model.codec.impl.BaseFeatureConfigImpl#getSerializeDefaults <em>Serialize Defaults</em>}</li>
 *   <li>{@link org.eclipse.fennec.codec.metadata.model.codec.impl.BaseFeatureConfigImpl#getEnumSerialization <em>Enum Serialization</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BaseFeatureConfigImpl extends MinimalEObjectImpl.Container implements BaseFeatureConfig {
	...
	protected EClass eStaticClass() {
		return CodecPackage.Literals.BASE_FEATURE_CONFIG;
	}
	...
	public void setKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodecPackage.BASE_FEATURE_CONFIG__KEY, oldKey, key));
	}
	...
	public void setIgnore(Boolean newIgnore) {
		...
		ignore = newIgnore;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodecPackage.BASE_FEATURE_CONFIG__IGNORE, oldIgnore, ignore));
	}
	...
	public void setIgnoreRead(Boolean newIgnoreRead) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodecPackage.BASE_FEATURE_CONFIG__IGNORE_READ, oldIgnoreRead, ignoreRead));
	}
	...
	public void setIgnoreWrite(Boolean newIgnoreWrite) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodecPackage.BASE_FEATURE_CONFIG__IGNORE_WRITE, oldIgnoreWrite, ignoreWrite));
	}
	...
	public void setForceRead(Boolean newForceRead) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodecPackage.BASE_FEATURE_CONFIG__FORCE_READ, oldForceRead, forceRead));
	}
	...
	public void setForceWrite(Boolean newForceWrite) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodecPackage.BASE_FEATURE_CONFIG__FORCE_WRITE, oldForceWrite, forceWrite));
	}
	...
	public void setSerializeNull(Boolean newSerializeNull) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodecPackage.BASE_FEATURE_CONFIG__SERIALIZE_NULL, oldSerializeNull, serializeNull));
	}
	...
	public void setSerializeEmpty(Boolean newSerializeEmpty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodecPackage.BASE_FEATURE_CONFIG__SERIALIZE_EMPTY, oldSerializeEmpty, serializeEmpty));
	}
	...
	public void setSerializeDefaults(Boolean newSerializeDefaults) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodecPackage.BASE_FEATURE_CONFIG__SERIALIZE_DEFAULTS, oldSerializeDefaults, serializeDefaults));
	}
	...
	public void setEnumSerialization(EnumSerializationStrategy newEnumSerialization) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodecPackage.BASE_FEATURE_CONFIG__ENUM_SERIALIZATION, oldEnumSerialization, enumSerialization));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CodecPackage.BASE_FEATURE_CONFIG__KEY:
				return getKey();
			case CodecPackage.BASE_FEATURE_CONFIG__IGNORE:
				return getIgnore();
			case CodecPackage.BASE_FEATURE_CONFIG__IGNORE_READ:
				return getIgnoreRead();
			case CodecPackage.BASE_FEATURE_CONFIG__IGNORE_WRITE:
				return getIgnoreWrite();
			case CodecPackage.BASE_FEATURE_CONFIG__FORCE_READ:
				return getForceRead();
			case CodecPackage.BASE_FEATURE_CONFIG__FORCE_WRITE:
				return getForceWrite();
			case CodecPackage.BASE_FEATURE_CONFIG__SERIALIZE_NULL:
				return getSerializeNull();
			case CodecPackage.BASE_FEATURE_CONFIG__SERIALIZE_EMPTY:
				return getSerializeEmpty();
			case CodecPackage.BASE_FEATURE_CONFIG__SERIALIZE_DEFAULTS:
				return getSerializeDefaults();
			case CodecPackage.BASE_FEATURE_CONFIG__ENUM_SERIALIZATION:
