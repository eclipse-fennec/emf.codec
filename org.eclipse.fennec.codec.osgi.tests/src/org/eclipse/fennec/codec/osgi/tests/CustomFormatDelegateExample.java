...
/**
 * OSGi integration tests demonstrating a complete custom format using
...
@DisplayName("Custom Format Delegate OSGi Examples")
public class CustomFormatDelegateExample {
